...
namespace NSAttack
{
    internal class OrinOrbDrop : AttackBase
    {
        private readonly OrinOrbDrop.TYPE type;
        private readonly OrinOrbDrop.TYPE ctype;
            ...
            if (this.frame == this.time)
            {
                ...
                if (this.InArea && !this.StandPanel.Hole)
                {
                    if (!this.poizon)
                    {
                        ...
                        if (this.cluster)
                        {
                            this.parent.attacks.Add(this.StateCopy(new OrinOrbDrop(this.sound, this.parent, this.position.X, this.position.Y, this.union, this.power, 1, this.positionDirect, new Point(this.position.X - 1, this.position.Y), 20, this.ctype, false, OrinOrbDrop.TYPE.big, false, false)));
                            this.parent.attacks.Add(this.StateCopy(new OrinOrbDrop(this.sound, this.parent, this.position.X, this.position.Y, this.union, this.power, 1, this.positionDirect, new Point(this.position.X, this.position.Y - 1), 20, this.ctype, false, OrinOrbDrop.TYPE.big, false, false)));
                            this.parent.attacks.Add(this.StateCopy(new OrinOrbDrop(this.sound, this.parent, this.position.X, this.position.Y, this.union, this.power, 1, this.positionDirect, new Point(this.position.X + 1, this.position.Y), 20, this.ctype, false, OrinOrbDrop.TYPE.big, false, false)));
                            this.parent.attacks.Add(this.StateCopy(new OrinOrbDrop(this.sound, this.parent, this.position.X, this.position.Y, this.union, this.power, 1, this.positionDirect, new Point(this.position.X, this.position.Y + 1), 20, this.ctype, false, OrinOrbDrop.TYPE.big, false, false)));
                        }
                    }
                    else
                    {
                        ...
                        {
                            case OrinOrbDrop.TYPE.single:
                                this.parent.effects.Add(new OrinBadWater(this.sound, this.parent, this.position.X, this.position.Y, 2, OrinBadWater.TYPE.Poison, this.palette));
                                break;
                            case OrinOrbDrop.TYPE.line:
                                this.parent.effects.Add(new OrinBadWater(this.sound, this.parent, this.position.X, this.position.Y, 2));
                                AttackBase a1 = this.StateCopy(this.StateCopy(new BombAttack(this.sound, this.parent, this.position.X, this.position.Y - 1, this.union, this.power, 1, this.element)));
                                if (this.cluster)
                                    a1.invincibility = false;
                                this.parent.attacks.Add(this.StateCopy(a1));
                                this.parent.effects.Add(new OrinBadWater(this.sound, this.parent, this.position.X, this.position.Y - 1, 2));
                                AttackBase a2 = this.StateCopy(new BombAttack(this.sound, this.parent, this.position.X, this.position.Y + 1, this.union, this.power, 1, this.element));
                                if (this.cluster)
                                    a2.invincibility = false;
                                this.parent.attacks.Add(this.StateCopy(a2));
                            ...
                            case OrinOrbDrop.TYPE.closs:
                                ...
                                if (this.cluster)
                                    a3.invincibility = false;
                                this.parent.attacks.Add(this.StateCopy(a3));
                                this.parent.effects.Add(new OrinBadWater(this.sound, this.parent, this.position.X - 1, this.position.Y, 2));
                                AttackBase a4 = this.StateCopy(this.StateCopy(new BombAttack(this.sound, this.parent, this.position.X, this.position.Y - 1, this.union, this.power, 1, this.element)));
                                if (this.cluster)
                                    a4.invincibility = false;
                                this.parent.attacks.Add(this.StateCopy(a4));
                            ...
                            case OrinOrbDrop.TYPE.big:
                                ...
                                if (this.cluster)
                                    a11.invincibility = false;
                                this.parent.attacks.Add(this.StateCopy(a11));
                                this.parent.effects.Add(new OrinBadWater(this.sound, this.parent, this.position.X - 1, this.position.Y - 1, 2));
                                AttackBase a12 = this.StateCopy(new BombAttack(this.sound, this.parent, this.position.X + 1, this.position.Y - 1, this.union, this.power, 1, this.element));
                                if (this.cluster)
                                    a12.invincibility = false;
                                this.parent.attacks.Add(this.StateCopy(a12));
                        ...
                        if (this.cluster)
                        {
                            this.parent.attacks.Add(this.StateCopy(new OrinOrbDrop(this.sound, this.parent, this.position.X, this.position.Y, this.union, this.power, 1, this.positionDirect, new Point(this.position.X - 1, this.position.Y), 20, this.ctype, false, OrinOrbDrop.TYPE.single, this.poizon, false)));
                            this.parent.attacks.Add(this.StateCopy(new OrinOrbDrop(this.sound, this.parent, this.position.X, this.position.Y, this.union, this.power, 1, this.positionDirect, new Point(this.position.X, this.position.Y - 1), 20, this.ctype, false, OrinOrbDrop.TYPE.single, this.poizon, false)));
                            this.parent.attacks.Add(this.StateCopy(new OrinOrbDrop(this.sound, this.parent, this.position.X, this.position.Y, this.union, this.power, 1, this.positionDirect, new Point(this.position.X + 1, this.position.Y), 20, this.ctype, false, OrinOrbDrop.TYPE.single, this.poizon, false)));
                            this.parent.attacks.Add(this.StateCopy(new OrinOrbDrop(this.sound, this.parent, this.position.X, this.position.Y, this.union, this.power, 1, this.positionDirect, new Point(this.position.X, this.position.Y + 1), 20, this.ctype, false, OrinOrbDrop.TYPE.single, this.poizon, false)));
                        }
                    }
        ...
        public override void Render(IRenderer dg)
        {
            ...
            else
            {
                ...
                this._position = new Vector2((float)num1, (float)num3);
                this._rect = new Rectangle(50*3, 50*2 + adj, 50, 50);
