...
namespace NSAttack
{
    internal class OrinTailHoc : AttackBase
    {
        ...
        public OrinTailHoc(
          ...
          int s,
          Vector2 v,
          ChipBase.ELEMENT ele, bool up, int aS, int pal)
        ...
        public override void Updata()
        {
                ...
                if (this.waittime % this.aspeed == 0)
                {
                    switch (num)
                    {
                        ...
                        case 4://7:
                            ...
                            */
                            this.angleDOWN = true;
                            if (this.up) { this.angleDOWN = false; }
            ...
            else
            {
                ...
                {
                    ++this.animeflame;
                    if (this.animeflame > 5)
                        this.animeflame = 2;
                    this.animationpoint.X = 0 + this.animeflame;
                }
        ...
        public override void Render(IRenderer dg)
        {
            ...
            this._rect = new Rectangle(this.animationpoint.X * 50 + (50 * 4), 50*1 + adj, 50, 50);
            if (!this.up)
            {
                this._rect = new Rectangle(this.animationpoint.X * 50 + (50 * 10), 50 * 1 + adj, 50, 50);
            }
