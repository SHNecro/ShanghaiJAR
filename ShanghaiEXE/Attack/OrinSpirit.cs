...
namespace NSAttack
{
    internal class OrinSpirit : AttackBase
    {
        private int palette;
        ...
        public override void Render(IRenderer dg)
        {
            ...
            this._rect = new Rectangle(this.animationpoint.X * 50 + (50 * 8), 0 + adj, 50, 50);
            /*
            switch (this.element)
            {
            ...
            */
            dg.DrawImage(dg, "OrinAttack1", this._rect, true, this._position, this.rebirth, this.color);
        }
