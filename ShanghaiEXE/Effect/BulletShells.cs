...
namespace NSEffect
{
    internal class BulletShells : EffectBase
    {
        ...
        public override void Updata()
        {
            ...
            {
                if (this.count > 0)
                    this.parent.effects.Add(new BulletShells(this.sound, this.parent, this.position, this.positionDirect.X, this.positionDirect.Y, 0, this.union, this.time / 2, this.count - 1, this.spin));
                this.flag = false;
            }
            this.FlameControl();
        }
        ...
        {
            this._rect = new Rectangle(this.spin * 8, 800, 8, 8);
