...
namespace NSChip
{
    internal class BreakShot : ChipBase
  {
    private bool open;
    private const int shotend = 28;

    public BreakShot(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-3, 0);
      this.number = 22;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.BreakShotName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.BreakShotDesc");
    ...
    public override void Action(CharacterBase character, SceneBattle battle)
    {
      ...
      NSAttack.PoisonShot poisonShot = new NSAttack.PoisonShot(this.sound, character.parent, character.position.X, character.position.Y, character.union, this.Power(character), 1, v, this.element, end, 10, true, NSAttack.PoisonShot.TYPE.break_);
