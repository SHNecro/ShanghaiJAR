...
namespace NSChip
{
    internal class MedicineX : ChipBase
  {
      ...
      : base(s)
    {
      this.navi = true;
      this.number = 403;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.MedicineXName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.MedicineXDesc");
