...
namespace NSChip
{
    internal class IkuV3 : IkuV1
  {
    private const int speed = 2;
    private Point animePoint;

    public IkuV3(IAudioEngine s)
      : base(s)
    {
      this.navi = true;
      this.number = 226;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.IkuV3Name");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.IkuV3Desc");
