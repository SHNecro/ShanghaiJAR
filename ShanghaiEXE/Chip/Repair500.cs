...
namespace NSChip
{
    internal class Repair500 : ChipBase
  {
    private const int speed = 2;

    public Repair500(IAudioEngine s)
      : base(s)
    {
      this.number = 180;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.Repair500Name");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.Repair500Desc");
