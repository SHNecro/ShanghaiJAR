...
namespace NSChip
{
    internal class SynchroBody : ChipBase
  {
    ...
    {
      this.number = 184;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.SynchroBodyName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.SynchroBodyDesc");
