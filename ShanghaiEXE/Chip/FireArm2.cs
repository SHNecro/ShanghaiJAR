...
namespace NSChip
{
    internal class FireArm2 : ChipBase
  {
    private const int shotend = 28;
    private int count;

    public FireArm2(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-3, 0);
      this.number = 15;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.FireArm2Name");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.FireArm2Desc");
