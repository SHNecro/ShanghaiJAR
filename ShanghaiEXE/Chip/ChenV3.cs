...
namespace NSChip
{
    internal class ChenV3 : ChenV1
  {
    public ChenV3(IAudioEngine s)
      : base(s)
    {
      this.navi = true;
      this.number = 238;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.ChenV3Name");
      ...
      this.animePoint.X = -1;
      var information = NSGame.ShanghaiEXE.Translate("Chip.ChenV3Desc");
