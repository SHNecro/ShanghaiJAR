...
namespace NSChip
{
    internal class Storm : ChipBase
  {
    private const int start = 5;
    private const int speed = 3;

    public Storm(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-2, 0);
      this.number = 85;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.StormName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.StormDesc");
