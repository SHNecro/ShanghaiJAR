...
namespace NSChip
{
    internal class ParayzeCassette : ChipBase
  {
    private const int speed = 2;

    public ParayzeCassette(IAudioEngine s)
      : base(s)
    {
      this.number = 190;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.ParayzeCassetteName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.ParayzeCassetteDesc");
