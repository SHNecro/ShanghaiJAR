...
namespace NSChip
{
    internal class SamonBibity : ChipBase
  {
    ...
    {
      this.number = 204;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.SamonBibityName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.SamonBibityDesc");
      ...
      bool noicon)
    {
      if (!noicon)
      {
        ...
        if (select)
          num = 1;
        this._rect = new Rectangle(336, num * 16, 16, 16);
