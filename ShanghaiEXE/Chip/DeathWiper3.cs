...
namespace NSChip
{
    internal class DeathWiper3 : DeathWiper1
  {
      ...
      : base(s)
    {
      ...
      this.swordtype = true;
      this.number = 108;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.DeathWiper3Name");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.DeathWiper3Desc");
