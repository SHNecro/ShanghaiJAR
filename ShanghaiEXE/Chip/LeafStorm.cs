...
namespace NSChip
{
    internal class LeafStorm : ChipBase
  {
    private const int start = 5;
    private const int speed = 3;

    public LeafStorm(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-2, 0);
      this.number = 88;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.LeafStormName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.LeafStormDesc");
