...
namespace NSChip
{
    internal class KnightLance : ChipBase
  {
    private const int start = 5;
    private const int speed = 3;

    public KnightLance(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-1, 0);
      this.number = 72;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.KnightLanceName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.KnightLanceDesc");
