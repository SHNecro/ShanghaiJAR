...
namespace NSChip
{
    internal class PyroManX : PyroManV1
  {
    private const int speed = 2;

    public PyroManX(IAudioEngine s)
      : base(s)
    {
      this.navi = true;
      this.number = 410;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.PyroManXName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.PyroManXDesc");
    ...
    public override void Render(IRenderer dg, CharacterBase character)
    {
      ...
      {
        this._rect = new Rectangle(64 * this.animePoint.X, 192, 64, 96);
