...
namespace NSChip
{
    internal class PanelShoot1 : ChipBase
  {
      ...
      : base(s)
    {
      ...
      this.number = 100;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.PanelShoot1Name");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.PanelShoot1Desc");
