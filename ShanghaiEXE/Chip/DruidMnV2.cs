...
namespace NSChip
{
    internal class DruidMnV2 : ChipBase
    {
          ...
          : base(s)
        {
            this.navi = true;
            this.number = 246;
            this.name = ShanghaiEXE.Translate("Chip.DruidManV2Name");
            ...
            var informationDialogue = NSGame.ShanghaiEXE.Translate("Chip.DruidManV2Desc");
