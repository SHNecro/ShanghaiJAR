...
namespace NSChip
{
    internal class ElekiStorm : ChipBase
  {
    private const int start = 5;
    private const int speed = 3;

    public ElekiStorm(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-2, 0);
      this.number = 87;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.ElekiStormName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.ElekiStormDesc");
