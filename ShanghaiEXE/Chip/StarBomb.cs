...
namespace NSChip
{
    internal class StarBomb : ChipBase
  {
    private const int start = 3;
    private const int speed = 3;

    public StarBomb(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-3, 0);
      this.number = 45;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.StarBombName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.StarBombDesc");
    ...
    public override void Action(CharacterBase character, SceneBattle battle)
    {
      ...
      if (character.waittime == 6)
      {
        ...
        battle.attacks.Add(this.Paralyze(new ClossBomb(this.sound, character.parent, character.position.X, character.position.Y, character.union, this.Power(character), 1, new Vector2(character.positionDirect.X, character.positionDirect.Y - 16f), end, 40, ClossBomb.TYPE.closs, true, ClossBomb.TYPE.closs, false, false)));
      }
