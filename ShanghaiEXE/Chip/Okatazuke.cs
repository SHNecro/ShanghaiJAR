...
namespace NSChip
{
    internal class Okatazuke : ChipBase
  {
    ...
    {
      this.number = 146;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.OkatazukeName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.OkatazukeDesc");
    ...
    public override void Action(CharacterBase character, SceneBattle battle)
    {
      ...
      foreach (ObjectBase objectBase in battle.objects)
        objectBase.Break();
