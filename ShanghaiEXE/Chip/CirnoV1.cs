...
namespace NSChip
{
    internal class CirnoV1 : ChipBase
  {
    private const int start = 44;
    private const int speed = 2;
    private Point animePoint;

    public CirnoV1(IAudioEngine s)
      : base(s)
    {
      this.navi = true;
      this.number = 218;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.CirnoV1Name");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.CirnoV1Desc");
    ...
    public override void Action(CharacterBase character, SceneBattle battle)
    {
      ...
      switch (character.waittime)
      {
        ...
        case 44:
          ...
          character.parent.attacks.Add(this.Paralyze(new CirnoChip(this.sound, character.parent, character.position.X, character.position.Y, character.union, this.Power(character), false)));
          break;
      }
