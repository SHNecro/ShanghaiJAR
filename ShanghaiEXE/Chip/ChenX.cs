        ...
        public override void Action(CharacterBase character, SceneBattle battle)
        {
            ...
            switch (character.waittime)
            {
                ...
                case 32:
                    ...
                    this.attack = this.Paralyze(new ChenBoomerang(this.sound, battle, character.union == Panel.COLOR.red ? 0 : 5, this.target.Y, character.union, this.Power(character), 1, 1, this.element));
