...
namespace NSChip
{
    internal class Repair100 : ChipBase
  {
    ...
    {
      this.number = 176;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.Repair100Name");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.Repair100Desc");
