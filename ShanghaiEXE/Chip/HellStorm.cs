...
namespace NSChip
{
    internal class HellStorm : ChipBase
  {
    private const int start = 5;
    private const int speed = 3;

    public HellStorm(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-2, 0);
      this.number = 86;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.HellStormName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.HellStormDesc");
