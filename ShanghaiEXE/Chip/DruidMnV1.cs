...
namespace NSChip
{
    internal class DruidMnV1 : ChipBase
    {
        ...
        public DruidMnV1(IAudioEngine s)
          : base(s)
        {
            this.navi = true;
            this.number = 245;
            this.name = ShanghaiEXE.Translate("Chip.DruidManV1Name");
            ...
            var informationDialogue = NSGame.ShanghaiEXE.Translate("Chip.DruidManV1Desc");
