...
namespace NSChip
{
    internal class YorihimeV1 : ChipBase
    {
        ...
        public YorihimeV1(IAudioEngine s)
          : base(s)
        {
            this.navi = true;
            this.number = 215;
            this.name = NSGame.ShanghaiEXE.Translate("Chip.YorihimeV1Name");
            ...
            var information = NSGame.ShanghaiEXE.Translate("Chip.YorihimeV1Desc");
