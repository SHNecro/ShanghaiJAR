...
namespace NSChip
{
  internal class BubbleBlust3 : ChipBase
  {
    private const int shotend = 10;
    private const int shotinterval = 4;

    public BubbleBlust3(MyAudio s)
      : base(s)
    {
      this.rockOnPoint = new Point(-3, 0);
      this.number = 55;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.BubbleBlust3Name");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.BubbleBlust3Desc");
    ...
    {
      character.animationpoint = BubbleBlust3.Animation(character.waittime);
    ...
    {
      this._rect = new Rectangle(4 * character.Wide, 3 * character.Height, character.Wide, character.Height);
