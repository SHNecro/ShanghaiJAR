...
namespace NSChip
{
    internal class FireArm1 : ChipBase
  {
    private const int shotend = 28;
    private int count;

    public FireArm1(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-3, 0);
      this.number = 14;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.FireArm1Name");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.FireArm1Desc");
