...
namespace NSChip
{
    internal class IkuX : ChipBase
  {
      ...
      : base(s)
    {
      this.navi = true;
      this.number = 405;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.IkuXName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.IkuXDesc");
    ...
    public override void Render(IRenderer dg, CharacterBase character)
    {
      ...
      {
        this._rect = new Rectangle(80 * this.animePoint.X, 144, 80, 72);
