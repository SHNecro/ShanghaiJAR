...
namespace NSChip
{
    internal class ColdAir1 : ChipBase
  {
    private bool open;
    private const int shotend = 10;

    public ColdAir1(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-3, 0);
      this.number = 24;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.ColdAir1Name");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.ColdAir1Desc");
