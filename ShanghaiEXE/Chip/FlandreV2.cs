...
namespace NSChip
{
    internal class FlandreV2 : FlandreV1
    {
        ...
        public FlandreV2(IAudioEngine s)
          : base(s)
        {
            this.navi = true;

            this.number = 204;
            this.name = NSGame.ShanghaiEXE.Translate("Chip.FlandreV2Name");
            ...
            var information = NSGame.ShanghaiEXE.Translate("Chip.FlandreV2Desc");
          ...
          bool printstatus)
        {
            if (printgraphics)
            {
                this._rect = new Rectangle(56 * 7, 0, 56, 48);
