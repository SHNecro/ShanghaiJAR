...
namespace NSChip
{
    internal class BurnerRoad : ChipBase
  {
    ...
    {
      this.number = 160;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.BurnerRoadName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.BurnerRoadDesc");
    ...
    public override void Action(CharacterBase character, SceneBattle battle)
    {
      if (character.waittime == 1)
      {
        ...
        for (int pX = 0; pX < battle.panel.GetLength(0); ++pX)
        {
          ...
          {
            battle.panel[pX, y].state = Panel.PANEL._burner;
