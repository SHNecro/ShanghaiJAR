...
namespace NSChip
{
    internal class SeedCanon2 : SeedCanon1
  {
    private int posiminus = 0;
    private const int shotend = 58;
    private const int shotstart = 40;

    public SeedCanon2(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-3, 0);
      this.number = 5;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.SeedCanon2Name");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.SeedCanon2Desc");
