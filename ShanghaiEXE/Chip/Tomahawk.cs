...
namespace NSChip
{
    internal class Tomahawk : ChipBase
  {
    private const int start = 1;
    private const int speed = 2;

    public Tomahawk(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-3, 0);
      this.number = 103;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.TomahawkName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.TomahawkDesc");
