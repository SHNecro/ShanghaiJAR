...
namespace NSChip
{
    internal class BlindReaf : ChipBase
  {
    ...
    {
      this.number = 155;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.BlindReafName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.BlindReafDesc");
    ...
    public override void Action(CharacterBase character, SceneBattle battle)
    {
      ...
      else if (character.waittime == 15)
      {
        ...
        bombAttack.badstatustime[(int) this.element] = 360;
