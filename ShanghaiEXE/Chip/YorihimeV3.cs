...
namespace NSChip
{
    internal class YorihimeV3 : ChipBase
    {
          ...
          : base(s)
        {
            this.navi = true;
            this.number = 217;
            this.name = NSGame.ShanghaiEXE.Translate("Chip.YorihimeV3Name");
            ...
            var information = NSGame.ShanghaiEXE.Translate("Chip.YorihimeV3Desc");
