...
namespace NSChip
{
    internal class LeafSword : ChipBase
  {
    private const int start = 3;
    private const int speed = 2;

    public LeafSword(IAudioEngine s)
      : base(s)
    {
      ...
      this.swordtype = true;
      this.number = 64;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.LeafSwordName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.LeafSwordDesc");
