...
namespace NSChip
{
    internal class BubbleLotion : ChipBase
  {
    private const int start = 1;
    private const int speed = 2;

    public BubbleLotion(IAudioEngine s)
      : base(s)
    {
      this.number = 153;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.BubbleLotionName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.BubbleLotionDesc");
