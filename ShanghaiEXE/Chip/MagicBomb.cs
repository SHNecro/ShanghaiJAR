...
namespace NSChip
{
    internal class MagicBomb : ChipBase
  {
    private const int start = 3;
    private const int speed = 3;

    public MagicBomb(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-3, 0);
      this.number = 44;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.MagicBombName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.MagicBombDesc");
