...
namespace NSChip
{
    internal class ElekiChain3 : ChipBase
  {
    private const int speed = 4;
    private const int shotend = 16;

    public ElekiChain3(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-3, 0);
      this.number = 35;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.ElekiChain3Name");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.ElekiChain3Desc");
    ...
    public override void Action(CharacterBase character, SceneBattle battle)
    {
      ...
      character.parent.attacks.Add(this.Paralyze(new ChainAttack(this.sound, character.parent, character.position.X + this.UnionRebirth(character.union), character.position.Y, character.union, this.Power(character), 4, 2, true, this.element)));
    }
