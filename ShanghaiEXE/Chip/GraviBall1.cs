...
namespace NSChip
{
    internal class GraviBall1 : ChipBase
  {
      ...
      : base(s)
    {
      ...
      this.number = 40;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.GraviBall1Name");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.GraviBall1Desc");
