...
namespace NSChip
{
    internal class TankmanX : ChipBase
  {
    ...
    public TankmanX(IAudioEngine s)
      : base(s)
    {
      this.navi = true;
      this.number = 404;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.TankmanXName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.TankmanXDesc");
    ...
    public override void Render(IRenderer dg, CharacterBase character)
    {
      ...
      {
        this._rect = new Rectangle(88 * this.animePoint.X, 128, 88, 64);
