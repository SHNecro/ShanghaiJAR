...
namespace NSChip
{
    internal class HeavyAnchor2 : ChipBase
  {
      ...
      : base(s)
    {
      ...
      this.number = 47;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.HeavyAnchor2Name");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.HeavyAnchor2Desc");
    ...
    public override void Action(CharacterBase character, SceneBattle battle)
    {
      ...
      if (character.waittime == 6)
      {
        ...
        battle.attacks.Add(this.Paralyze(new AnchorBomb(this.sound, character.parent, character.position.X, character.position.Y, character.union, this.Power(character), 1, new Vector2(character.positionDirect.X, character.positionDirect.Y - 16f), end, 30, AnchorBomb.TYPE.line, -1)));
      }
