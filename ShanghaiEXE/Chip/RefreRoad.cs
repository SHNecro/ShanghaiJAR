...
namespace NSChip
{
    internal class RefreRoad : ChipBase
  {
    private const int speed = 2;

    public RefreRoad(IAudioEngine s)
      : base(s)
    {
      this.number = 172;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.RefreRoadName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.RefreRoadDesc");
