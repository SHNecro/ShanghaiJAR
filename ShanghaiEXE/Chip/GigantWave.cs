...
namespace NSChip
{
    internal class GigantWave : ChipBase
  {
    private const int start = 1;
    private const int speed = 2;

    public GigantWave(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-1, 0);
      this.number = 20;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.GigantWaveName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.GigantWaveDesc");
