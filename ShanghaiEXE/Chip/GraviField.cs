...
namespace NSChip
{
    internal class GraviField : ChipBase
  {
    ...
    {
      this.number = 156;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.GraviFieldName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.GraviFieldDesc");
