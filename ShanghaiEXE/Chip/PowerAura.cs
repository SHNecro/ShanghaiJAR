...
namespace NSChip
{
    internal class PowerAura : ChipBase
  {
    ...
    {
      this.number = 150;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.PowerAuraName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.PowerAuraDesc");
