...
namespace NSChip
{
    internal class HeavyAnchor1 : ChipBase
  {
    private const int start = 3;
    private const int speed = 3;

    public HeavyAnchor1(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-3, 0);
      this.number = 46;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.HeavyAnchor1Name");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.HeavyAnchor1Desc");
    ...
    public override void Action(CharacterBase character, SceneBattle battle)
    {
      ...
      if (character.waittime == 6)
      {
        ...
        battle.attacks.Add(this.Paralyze(new AnchorBomb(this.sound, character.parent, character.position.X, character.position.Y, character.union, this.Power(character), 1, new Vector2(character.positionDirect.X, character.positionDirect.Y - 16f), end, 30, AnchorBomb.TYPE.single, -1)));
      }
