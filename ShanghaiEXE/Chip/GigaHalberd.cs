...
namespace NSChip
{
    internal class GigaHalberd : ChipBase
  {
    private const int start = 5;
    private const int speed = 4;

    public GigaHalberd(MyAudio s)
      : base(s)
    {
      this.infight = true;
      this.number = 274;
      ...
      bool printstatus)
    {
      ...
      {
        ShanghaiEXE.Translate("Chip.ProgramAdvanceGigaHalberdCombo1Line1"),
        ShanghaiEXE.Translate("Chip.ProgramAdvanceGigaHalberdCombo1Line2"),
        ShanghaiEXE.Translate("Chip.ProgramAdvanceGigaHalberdCombo1Line3")
      };
