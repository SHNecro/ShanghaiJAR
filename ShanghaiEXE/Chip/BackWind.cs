...
namespace NSChip
{
    internal class BackWind : ChipBase
  {
    ...
    public BackWind(IAudioEngine s)
      : base(s)
    {
      this.number = 92;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.BackWindName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.BackWindDesc");
    ...
    public override void Action(CharacterBase character, SceneBattle battle)
    {
      ...
      battle.effects.Add(new NSEffect.BackWind(this.sound, battle, new Vector2(), new Point(), character.union));
