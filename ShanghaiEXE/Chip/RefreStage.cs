...
namespace NSChip
{
    internal class RefreStage : ChipBase
  {
    private const int speed = 2;

    public RefreStage(IAudioEngine s)
      : base(s)
    {
      this.number = 173;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.RefreStageName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.RefreStageDesc");
