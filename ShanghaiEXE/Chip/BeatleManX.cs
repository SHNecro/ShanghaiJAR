...
namespace NSChip
{
    internal class BeatleManX : BeatleManV1
  {
    private const int speed = 2;

    public BeatleManX(IAudioEngine s)
      : base(s)
    {
      this.navi = true;
      this.number = 411;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.BeatleManXName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.BeatleManXDesc");
    ...
    public override void Render(IRenderer dg, CharacterBase character)
    {
      ...
      {
        this._rect = new Rectangle(112 * this.animationpoint.X, 224, 112, 112);
