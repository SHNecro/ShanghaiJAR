...
namespace NSChip
{
    internal class AquaStorm : ChipBase
  {
      ...
      : base(s)
    {
      ...
      this.number = 89;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.AquaStormName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.AquaStormDesc");
