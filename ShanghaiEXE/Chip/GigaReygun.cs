...
namespace NSChip
{
    internal class GigaReygun : ChipBase
  {
    private const int shotend = 28;

    public GigaReygun(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-3, 0);
      this.number = 3;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.GigaReygunName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.GigaReygunDesc");
    ...
    public override void Render(IRenderer dg, CharacterBase character)
    {
      if (character.waittime < 5)
        return;
      this._rect = new Rectangle(360, 0, character.Wide, character.Height);
