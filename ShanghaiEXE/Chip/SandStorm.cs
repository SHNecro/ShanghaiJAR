...
namespace NSChip
{
    internal class SandStorm : ChipBase
  {
    private const int start = 5;
    private const int speed = 3;

    public SandStorm(IAudioEngine s)
      : base(s)
    {
      this.rockOnPoint = new Point(-2, 0);
      this.number = 90;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.SandStormName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.SandStormDesc");
