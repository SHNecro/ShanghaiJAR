...
namespace NSChip
{
    internal class MarisaV1 : ChipBase
  {
      ...
      : base(s)
    {
      this.navi = true;
      this.number = 191;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.MarisaV1Name");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.MarisaV1Desc");
