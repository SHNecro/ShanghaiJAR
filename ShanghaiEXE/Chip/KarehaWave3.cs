...
namespace NSChip
{
    internal class KarehaWave3 : ChipBase
  {
    private const int start = 1;
    private const int speed = 2;

    public KarehaWave3(IAudioEngine s)
      : base(s)
    {
      this.number = 117;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.KarehaWave3Name");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.KarehaWave3Desc");
