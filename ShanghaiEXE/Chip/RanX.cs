...
namespace NSChip
{
    internal class RanX : RanV1
  {
    private const int speed = 2;

    public RanX(IAudioEngine s)
      : base(s)
    {
      this.navi = true;
      this.number = 415;
      this.name = NSGame.ShanghaiEXE.Translate("Chip.RanXName");
      ...
      var information = NSGame.ShanghaiEXE.Translate("Chip.RanXDesc");
